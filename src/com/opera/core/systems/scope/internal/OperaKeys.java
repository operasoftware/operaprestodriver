...
public enum OperaKeys {
  ...
  UP("up"), ARROW_UP("up"), // alias
  RIGHT("right"), ARROW_RIGHT("right"), // alias
  DOWN("down"), ARROW_DOWN("down"), // alias
  INSERT("insert"), DELETE("del"), SEMICOLON(";"), EQUALS("="),

  NUMPAD0("0"), // number pad keys
  NUMPAD1("1"), NUMPAD2("2"), NUMPAD3("3"), NUMPAD4("4"), NUMPAD5("5"), NUMPAD6(
      "6"), NUMPAD7("7"), NUMPAD8("8"), NUMPAD9("9"), MULTIPLY("*"), ADD("+"), SEPARATOR(
      ","), SUBTRACT("-"), DECIMAL("."), DIVIDE("/"),

  F1("f1"), // function keys
  F2("f2"), F3("f3"), F4("f4"), F5("f5"), F6("f6"), F7("f7"), F8("f8"), F9("f9"), F10(
      "f10"), F11("f11"), F12("f12"), ;

...
public final class ConsoleLoggerProtos {
  ...
  public static final class ConsoleMessage extends
    ...
    private static final ConsoleMessage defaultInstance = new ConsoleMessage();
    ...
    public java.lang.String getSeverity() { return severity_; }
    ...
    public int getSerializedSize() {
      ...
      if (hasContext()) {
        size += com.google.protobuf.CodedOutputStream
          .computeStringSize(5, getContext());
      }
      if (hasSource()) {
        size += com.google.protobuf.CodedOutputStream
      ...
      if (hasSeverity()) {
        size += com.google.protobuf.CodedOutputStream
          .computeStringSize(7, getSeverity());
      }
  ...
  result.hasSeverity = true;
    ...
    static {
      com.opera.core.systems.scope.protos.ConsoleLoggerProtos.getDescriptor();
    }

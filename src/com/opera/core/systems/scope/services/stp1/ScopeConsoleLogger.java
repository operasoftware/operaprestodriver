...
import com.opera.core.systems.scope.services.messages.ConsoleLoggerMessage;
...
public class ScopeConsoleLogger extends AbstractService implements ConsoleLogger {
  ...
  public ScopeConsoleLogger(ScopeServices services, String version) {
    super(services, "console-logger", version);

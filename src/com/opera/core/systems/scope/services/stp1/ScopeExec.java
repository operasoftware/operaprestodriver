...
import com.opera.core.systems.scope.services.messages.ExecMessage;
...
public class ScopeExec extends AbstractService implements Exec {
  ...
  public ScopeExec(ScopeServices services, String version) {
    super(services, "exec", version, "3.0");

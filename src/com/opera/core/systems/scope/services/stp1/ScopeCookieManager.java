...
import com.opera.core.systems.scope.services.messages.CookieManagerMessage;
...
public class ScopeCookieManager extends AbstractService implements CookieManager {
  ...
  public ScopeCookieManager(ScopeServices services, String version) {
    super(services, "cookie-manager", version);
  ...
  private CookieSettings getCookieSettings() {
    Response response = executeMessage(
        CookieManagerMessage.GET_COOKIE_SETTINGS, null);

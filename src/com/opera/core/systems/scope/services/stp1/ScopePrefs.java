...
import com.opera.core.systems.scope.services.messages.PrefsMessage;
...
public class ScopePrefs extends AbstractService implements Prefs {
  ...
  public ScopePrefs(ScopeServices services, String version) {
    super(services, "prefs", version, "2.0");

...
public interface IDesktopWindowManager {
   ...
   *
   * @param key        the shortcut key of the menuitem to search for (the character that's
   *                   underlined/marked in the menuitem text)
   ...
   *             selected The name of the submenu the item opens when selected "Separator" for items
   *             that are separators
   */
   ...
   * @param windowId id of the window the menu is attaced to (Note. Only makes sense for menubar)

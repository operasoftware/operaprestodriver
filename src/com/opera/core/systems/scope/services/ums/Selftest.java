...
public class Selftest extends AbstractService implements ISelftest {
  ...
  ServiceCallback<SelftestProtos.SelftestResult> callback = null;
  ...
  public RunStatus runSelftests(Set<String> modules, String groups, String excludes) {
    ...
    Response response = executeCommand(SelftestCommand.RUN_TESTS, argBuilder);
  ...
  public Map<String, List<String>> getAvailableGroups() {
    Response response = executeCommand(SelftestCommand.GET_TESTSGROUPS);
  ...
  public static class SelftestResult implements ISelftestResult {
     ...
     * {@link SelftestResult.Builder} constructor.
     */

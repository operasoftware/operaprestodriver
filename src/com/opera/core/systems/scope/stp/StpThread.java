...
public class StpThread extends Thread {
    ...
    public StpThread(int port, IConnectionHandler handler, AbstractEventHandler eventHandler, boolean manual_connect) throws IOException
    {
        SocketMonitor.instance();
        listener = new StpConnectionListener(port, handler, eventHandler, manual_connect);
        setName("stp-thread");
    }

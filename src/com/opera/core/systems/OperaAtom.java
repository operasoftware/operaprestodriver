...
public enum OperaAtom {
  ...
  MOVE_CARET_TO_END(
    "function(){return function(){function a(d){d.setSelectionRange(d.value.length,d.value.length" +
    ")}var b=[\"_\"],c=this;!(b[0]in c)&&c.execScript&&c.execScript(\"var \"+b[0]);for(var e;b.le" +
    "ngth&&(e=b.shift());)!b.length&&void 0!==a?c[e]=a:c=c[e]?c[e]:c[e]={};; return this._.apply(" +
    "null,arguments);}.apply({navigator:typeof window!=undefined?window.navigator:null}, argument" +
    "s);}"
  ),

...
/**
 * This will monitor any selectable channel, such as a SocketChannel or ServerSocketChannel and fire
 * canWrite() or canRead() events when such events are detected by poll().
 *

...
public class OperaLauncherProtocol {
  ...
  private ResponseEncapsulation recvMessage() throws IOException {
    ...
    if (headers[0] != 'L' || headers[1] != '1') throw new IOException(
    ...
    if (type == null) throw new IOException("Unable to determine message type");

    if ((headers[3] != (byte) 1) && (headers[3] != (byte) 2)) throw new IOException(

...
/*
	        ...
	        driver.pressQuickMenuItem("New Window");
	        menu_text = driver.waitForMenuItemPressed("New Window");
	        System.out.println("Menu Found: "+menu_text);
	*/

/*	        driver.pressQuickMenuItem("Tools");
	        String menu_text = driver.waitForMenuItemPressed("Tools");
	        System.out.println("Menu Found: "+menu_text);

	        driver.pressQuickMenuItem("Opera Unite");
	        menu_text = driver.waitForMenuItemPressed("Opera Unite");
	        System.out.println("Menu Found: "+menu_text);

	        driver.pressQuickMenuItem("What is Opera Unite?");
